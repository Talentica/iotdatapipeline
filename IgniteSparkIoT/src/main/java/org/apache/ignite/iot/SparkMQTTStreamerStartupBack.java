...
public class SparkMQTTStreamerStartupBack {
    ...
    private static void streamSensorMeasurements() throws InterruptedException {
        ...
        new Timer().schedule(new TimerTask() {
            @Override public void run() {
                ...
                Dataset ds = tempRdd.sql("SELECT * From Float ");
    ...
    private static void streamSensorMeasurementsJSON() throws InterruptedException {
        ...
        new Timer().schedule(new TimerTask() {
            @Override public void run() {
                ...
                dsRaw.show();
                Dataset dsMax = tempRdd.sql("SELECT sensorId , max(temp) From Float group by sensorId ");
                dsMax.show();
